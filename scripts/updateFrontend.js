...
try {
  ...
  // Get latest frontend release: https://github.com/hanzoui/frontend/releases
  const latestRelease = 'https://api.github.com/repos/hanzoui/frontend/releases/latest';
  ...
  const prBody = `Automated frontend update to ${version}: https://github.com/hanzoui/frontend/releases/tag/v${version}`;
